describe("Fast Project Model tests for ICFD health",function(){
    ...
    describe("When adding ICFD data to calculate churn by count", function(){
        it('should reset health measures',function() {
            ...
            var accepted_day_1 = Ext.create('mockCFD',{ CardState:'Accepted', CardCount:3, CardEstimateTotal: 0, CreationDate: friday });
            var in_p_day_1 = Ext.create('mockCFD',{ CardState:'In-Progress', CardCount:3, CardEstimateTotal: 1, CreationDate: friday });
            var defined_day_1 = Ext.create('mockCFD',{ CardState:'Defined', CardCount:3, CardEstimateTotal: 4, CreationDate: friday });
    ...
    describe("When adding ICFD data to projects calculate churn",function(){
        it('should provide 0 when no changes in sizes',function() {
            ...
            var accepted_day_2 = Ext.create('mockCFD',{ CardState:'Accepted', CardCount: 1, CreationDate: tuesday });
            var in_p_day_2 = Ext.create('mockCFD',{ CardState:'In-Progress', CardCount: 2, CreationDate: tuesday });
            var defined_day_2 = Ext.create('mockCFD',{ CardState:'Defined', CardCount: 2, CreationDate: tuesday });
        ...
        it('should provide standard deviation when value increased',function() {
            ...
            var accepted_day_1 = Ext.create('mockCFD',{ CardState:'Accepted', CardCount: 0, CreationDate: monday });
            var in_p_day_1 = Ext.create('mockCFD',{ CardState:'In-Progress', CardCount: 1, CreationDate: monday });
            var defined_day_1 = Ext.create('mockCFD',{ CardState:'Defined', CardCount: 1, CreationDate: monday });

            var accepted_day_2 = Ext.create('mockCFD',{ CardState:'Accepted', CardCount: 3, CreationDate: tuesday });
            ...
            var accepted_day_3 = Ext.create('mockCFD',{ CardState:'Accepted', CardCount: 6, CreationDate: wednesday });
            var in_p_day_3 = Ext.create('mockCFD',{ CardState:'In-Progress', CardCount: 1, CreationDate: wednesday });
            var defined_day_3 = Ext.create('mockCFD',{ CardState:'Defined', CardCount: 1, CreationDate: wednesday });
        ...
        it('should provide standard deviation when value decreased',function() {            
            ...
            var accepted_day_1 = Ext.create('mockCFD',{ CardState:'Accepted', CardCount: 6, CreationDate: monday });
            var in_p_day_1 = Ext.create('mockCFD',{ CardState:'In-Progress', CardCount: 1, CreationDate: monday });
            var defined_day_1 = Ext.create('mockCFD',{ CardState:'Defined', CardCount: 1, CreationDate: monday });
